...
return {
    ...
    calculate = function(self, card, context)
        if card.ability.extra.level > 0 and context.repetition and context.cardarea == G.play and context.scoring_name ==
            card.ability.extra.hand_type then
            card.ability.extra.level = G.GAME.VictinsCollection.zodiac.gemini
            local level = card.ability.extra.level -- G.GAME.hands[card.ability.extra.hand_type].level
            return {

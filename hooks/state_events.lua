                        ...
                        func = function()
                            if G.GAME.current_round.hands_left >= 0 then
                                    ...
                                    func = function()
                                        ...
                                        for k, _card in ipairs(_joker.ability.extra.highlighted_cards) do
                                            if _card and not _card.removed then
                                                ...
                                                draw_card(_card.area or G.discard, G.hand,
                                                    k * 100 / #_joker.ability.extra.highlighted_cards, 'up', nil, _card,
                                                    0.005, k % 2 == 0, nil, math.max((21 - k) / 20, 0.7))
                                            else
                                        ...
                                        G.E_MANAGER:add_event(Event({
                                            ...
                                            func = function()
                                                table.sort(G.hand.cards, function(a, b)
                                                    ...
                                                    for k, _v in ipairs(_joker.ability.extra.highlighted_cards) do
                                                        sendDebugMessage(tostring(k) .. " is " ..
                                                                             tostring(_v.base.value) .. " of " ..
                                                                             tostring(_v.base.suit))
                                                    end
                                ...
                                G.E_MANAGER:add_event(Event({
                                    ...
                                    func = function()
                                        ...
                                        for _, _card in ipairs(_joker.ability.extra.highlighted_cards) do
                                            if _card and not _card.removed then
                                                sendDebugMessage("Highlighted!");
                                                G.hand:add_to_highlighted(_card)
                                            else
                                                sendDebugMessage("Nothing to highlight…")
                                            end
                                        end
                                        return true
                                    end
                                ...
                                G.E_MANAGER:add_event(Event({
                                    ...
                                    func = function()
                                        ...
                                        table.sort(G.hand.cards, function(a, b)
                                            ...
                                            for k, _v in ipairs(_joker.ability.extra.highlighted_cards) do
                                                sendDebugMessage(
                                                    tostring(k) .. " is " .. tostring(_v.base.value) .. " of " ..
                                                        tostring(_v.base.suit))
                                            end
                                            local is_a_highlighted = is_in_highlighted_cards(a)
                                            local is_b_highlighted = is_in_highlighted_cards(b)
                                ...
                                G.E_MANAGER:add_event(Event({
                                    trigger = 'immediate',
                                    func = function()
                                        if G.GAME.current_round.hands_left <= 0 or _joker.ability.extra.cycles >= 100 or
                                            (G.GAME.chips - G.GAME.blind.chips >= 0) or G.STATE == G.STATES.NEW_ROUND then
                                            for i = 1, #G.hand.highlighted do
                                                draw_card(G.hand, G.play, i * 100 / #G.hand.highlighted, 'up', nil,

...
function G.UIDEF.vic_speech_bubble(text_key, loc_vars, extra)
    ...
    for k, v in ipairs(text) do
        ...
        row[#row + 1] = {
            n = G.UIT.R,
            config = {
                align = extra.text_alignment or "cl"
            },
            nodes = v
        }
    end
    local t = {
        ...
        config = {
            ...
            padding = 0.07,
            minw = 1,
            colour = extra.root_colour or G.C.JOKER_GREY,
            shadow = true
        },
        nodes = {{
            n = G.UIT.C,
            config = {
                ...
                padding = 0.1,
                minw = 1,
                colour = extra.bg_colour or G.C.WHITE
            },
            nodes = {{
                n = G.UIT.C,
                config = {
